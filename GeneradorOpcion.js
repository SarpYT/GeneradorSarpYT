...
<select class="SarpB" onchange="document.getElementById('iframe2').src = this.options[this.selectedIndex].value;">
  
<option value="${enlace1}">servidor 1</option> 

<option value="${enlace2}">servidor 2</option>

<option value="${o}">servidor 3</option>

</select>
<br><br>

<div class="iframe-container"> <iframe allowfullscreen="0" frameborder="0" height="215px" id="iframe2" onload="$('.iframe-loading').css('background-image', 'none');" ${sand} scrolling="no" src=" ${enlace1} " style="border: none;" width="100%"></iframe> </div>
